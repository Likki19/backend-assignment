...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.2.9/reference/htmlsingle/index.html#messaging.kafka)
...
* [Spring Cache Abstraction](https://docs.spring.io/spring-boot/docs/3.2.9/reference/htmlsingle/index.html#io.caching)
